...
// framing, never assigned to a specific commodity row. Easy to extend:
// add a new filename here as more are created.
export const DECORATIVE_IMAGES = {
  ...
  crate: '/products/decorative/corner-product-crate.png',
};
