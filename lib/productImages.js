...
const IMAGE_MAP = {
  ...
  // Color-specific bell peppers are separate Product Master commodities from
  // the generic 'bell pepper' above. Red reuses the existing generic single
  // (never replace that file) paired with its own new cluster photo.
  'red bell pepper':    { single: '/products/singles/bell-pepper-single.png',           cluster: '/products/price-sheet/red-bell-pepper-cluster.png' },
  'yellow bell pepper': { single: '/products/singles/yellow-bell-pepper-single.png',    cluster: '/products/price-sheet/yellow-bell-pepper-cluster.png' },
  'orange bell pepper': { single: '/products/singles/orange-bell-pepper-single.png',    cluster: '/products/price-sheet/orange-bell-pepper-cluster.png' },
  'green bell pepper':  { single: '/products/singles/green-bell-pepper-single.png',     cluster: '/products/price-sheet/green-bell-pepper-cluster.png' },
...
const ALIASES = {
  ...
  // Choice is a grade, not a different-looking commodity — same photo as
  // the corresponding color's regular bell pepper.
  'red bell pepper choice': 'red bell pepper',
  'yellow bell pepper choice': 'yellow bell pepper',
  'orange bell pepper choice': 'orange bell pepper',
  'green bell pepper choice': 'green bell pepper',
};
